                        ...
                        <td style="padding: 40px;">
                            ...
                            <div style="background-color: #fef3c7; border-left: 4px solid #f59e0b; padding: 16px; border-radius: 6px; margin-top: 24px;">
                                <p style="margin: 0; font-size: 13px; color: #92400e; line-height: 1.5;">
                                    <strong>ℹ️ Note:</strong> This is an automated response generated by AI. A human will review your message and provide a detailed reply if needed.
                                </p>
                            </div>
                        </td>
                    </tr>
                                ...
                                <tr>
                                    <td style="text-align: center;">
                                        ...
                                        <p style="margin: 0 0 4px 0; font-size: 12px; color: #9ca3af;">
                                            Powered by AI Email Auto-Reply System
                                        </p>
